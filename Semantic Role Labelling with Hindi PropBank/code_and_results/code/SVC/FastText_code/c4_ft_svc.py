...
for z in range(1):
    ...
    joblib.dump(svclassifier, f'Classification/model_fasttext_svc/model_4_both_dependencies.pkl')
    with open(f'Classification/results_fasttext_svc/both_dependencies_results.txt', 'a') as f:
