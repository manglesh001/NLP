...
for dropped in params_to_test:
    ...
    joblib.dump(svclassifier, f'Classification/model_fasttext_svc/model_3_{dropped}.pkl')
    with open(f'Classification/results_fasttext_svc/head_with_{dropped}_results.txt', 'a') as f:
