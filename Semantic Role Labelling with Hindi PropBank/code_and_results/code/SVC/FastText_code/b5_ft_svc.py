...
for z in range(1):
    ...
    joblib.dump(svclassifier, f'identification/model_fasttext_svc/model_5_head_both_dependencies.pkl')
    with open(f'identification/results_fasttext_svc/head_both_dependencies_results.txt', 'a') as f:
