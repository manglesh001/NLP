...
for dropped in params_to_test:    
    ...
    joblib.dump(svclassifier, f'identification/model_fasttext_svc/model_1_{dropped}.pkl')
    with open(f'identification/results_fasttext_svc/{dropped}_results.txt', 'a') as f:
