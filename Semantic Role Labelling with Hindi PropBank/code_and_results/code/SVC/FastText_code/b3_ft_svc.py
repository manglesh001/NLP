...
for dropped in params_to_test:
    ...
    joblib.dump(svclassifier, f'identification/model_fasttext_svc/model_3_{dropped}.pkl')
    with open(f'identification/results_fasttext_svc/head_with_{dropped}_results.txt', 'a') as f:
