...
for dropped in params_to_test:    
    ...
    joblib.dump(svclassifier, f'identification/model_word2vec_svc/model_1_{dropped}.pkl')
    with open(f'identification/results_word2vec_svc/{dropped}_results.txt', 'a') as f:
