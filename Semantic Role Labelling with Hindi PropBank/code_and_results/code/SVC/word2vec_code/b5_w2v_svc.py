...
for z in range(1):
    ...
    joblib.dump(svclassifier, f'identification/model_word2vec_svc/model_5_head_both_dependencies.pkl')
    with open(f'identification/results_word2vec_svc/head_both_dependencies_results.txt', 'a') as f:
