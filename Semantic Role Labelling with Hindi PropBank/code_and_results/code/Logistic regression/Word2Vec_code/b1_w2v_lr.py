...
for curr in temp:
    ...
    joblib.dump(logistic_classifier, f'identification/model_w2v_logistic/model_1_{dropped}.pkl')
    with open(f'identification/results_w2v_logistic/{dropped}_results.txt', 'a') as f:
