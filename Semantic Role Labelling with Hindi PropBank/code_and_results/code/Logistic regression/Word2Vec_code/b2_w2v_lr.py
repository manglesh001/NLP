...
joblib.dump(logistic_classifier, f'identification/model_w2v_logistic/model_2_head.pkl')
with open(f'identification/results_w2v_logistic/head_results.txt', 'a') as f:
