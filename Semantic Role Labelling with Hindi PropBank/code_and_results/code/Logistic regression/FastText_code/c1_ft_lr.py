...
for curr in temp:
    ...
    joblib.dump(logistic_classifier, f'classification/model_fasttext_logistic/model_1_{dropped}.pkl')
    with open(f'classification/results_fasttext_logistic/{dropped}_results.txt', 'a') as f:
