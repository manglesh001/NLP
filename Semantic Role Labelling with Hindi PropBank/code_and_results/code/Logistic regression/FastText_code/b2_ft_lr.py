...
joblib.dump(logistic_classifier, f'identification/model_fasttext_logistic/model_2_head.pkl')
with open(f'identification/results_fasttext_logistic/head_results.txt', 'a') as f:
